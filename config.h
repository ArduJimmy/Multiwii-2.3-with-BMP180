...
#define ARMEDTIMEWARNING 330  // (*) Trigger an alarm after a certain time of being armed [s] to save you lipo (if your TX does not have a countdown)
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       420 // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     370 // 12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 330 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2 300 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT  300 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
